...
const Page = () => {
  ...
  return (
    <div className="bg-denary flex flex-row h-screen  w-full">
      ...
      <div className="flex-1 min-h-0 h-full px-6 flex flex-col gap-4 w-full shrink-0 overflow-hidden">
        <div className="flex flex-row items-center w-full justify-between h-[80px]">
          {/* search bar */}
            ...
            <div className="absolute inset-0 bg-linear-to-tr from-denary/95 from-20% to-denary  via-transparent flex flex-col justify-between p-4">
              ...
              <div className="flex flex-col gap-2 mb-5">
                ...
                <div className="flex flex-row items-center gap-2 mt-1">
                  <button className="bg-senary text-white px-4 py-2 rounded-md flex flex-row items-center gap-2 cursor-pointer">
