...
const DashboardNav = () => {
  ...
  return (
    <div className="w-[40%] max-w-[250px] h-full  flex flex-col items-center  border-r border-r-greys1/20 shrink-0 bg-greys3/70">
      <div className="flex flex-row items-center justify-between w-full border-b border-b-greys1/20 px-5 h-[60px]">
        ...
        <div className="cursor-pointer text-greys2/50 hover:text-white transition-all duration-300 p-2 rounded-md hover:bg-greys1/10">
          <TbLayoutSidebarRight className=" text-xl" />
        </div>
      </div>

      <div className="flex-1 w-full flex flex-col justify-between h-full max-h-[calc(100vh-60px)]">
        {/* nav items */}
        <div className="flex flex-col gap-6 h-[40%] overflow-y-scroll cus-scrollbar py-5 px-3">
          {navSections.map(section => (
            <div key={section.title} className="flex flex-col gap-2">
              <p className="text-greys1 uppercase font-medium text-xs ">{section.title}</p>
                  ...
                  return (
                    <div
                      ...
                      className={`flex flex-row items-center gap-2  ${
                        isSelected ? "text-senary bg-senary/5" : "text-white"
        ...
        <div className="flex flex-col px-3 items-center">
          ...
          <div className=" bg-[#1D1D20] middle-curve-clip rounded-md border border-greys1/20 w-full flex flex-col  pt-6 px-3 pb-3">
        ...
        {/* user details */}
        <div className="flex flex-row items-center justify-between w-full px-3 py-4">
