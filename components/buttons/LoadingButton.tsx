...
const LoadingButton = ({ text, isLoading, Icon, onClick = () => { }, loadingText = "Loading..." }: { text: string, isLoading: boolean, Icon: React.ReactNode, onClick?: () => void, loadingText?: string }) => {
    return (
